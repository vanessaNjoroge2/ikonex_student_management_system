        ...
        <div className="bg-white border border-slate-200/80 p-8 rounded-3xl shadow-xl space-y-6">
          ...
          <div className="text-center pt-2 border-t border-slate-100 space-y-2">
            <div>
              ...
              <Link to="/register" className="text-xs font-bold text-[#3525cd] hover:underline">
                Create an account
              </Link>
            </div>
            <div className="pt-1.5">
              <span className="text-[11px] text-slate-400">School Administrator? </span>
              <Link to="/admin-login" className="text-[11px] font-bold text-[#3525cd] hover:underline">
                Admin Sign In
              </Link>
            </div>
          </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 focus:border-[#3525cd] focus:ring-1 focus:ring-[#3525cd]/30 text-slate-800 rounded-xl pl-10 pr-4 py-3 text-xs outline-none transition font-semibold"
                      />
                    </div>
                  </div>
                  <button
                    ...
                    className="w-full bg-[#3525cd] text-white py-3.5 rounded-xl font-bold text-xs shadow-md shadow-indigo-600/10 cursor-pointer hover:bg-[#4f46e5] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                  >
                    {forgotLoading ? (
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                    ) : (
                ...
                <form onSubmit={handleForgotReset} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 focus:border-[#3525cd] focus:ring-1 focus:ring-[#3525cd]/30 text-slate-800 text-center tracking-[4px] rounded-xl px-3.5 py-3 text-xs outline-none transition font-bold"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-50 border border-slate-200 focus:border-[#3525cd] focus:ring-1 focus:ring-[#3525cd]/30 text-slate-800 rounded-xl px-3.5 py-3 text-xs outline-none transition font-medium"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={forgotLoading}
                    className="w-full bg-[#3525cd] text-white py-3.5 rounded-xl font-bold text-xs shadow-md shadow-indigo-600/10 cursor-pointer hover:bg-[#4f46e5] active:scale-[0.98] transition-all flex items-center justify-center"
                  >
                    {forgotLoading ? (
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                    ) : (
                  ...
                  <button
                    ...
                    className="w-full text-slate-500 hover:text-[#3525cd] font-bold text-[10px] tracking-wide uppercase py-1 transition cursor-pointer"
                  >
