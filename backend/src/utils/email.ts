...
export async function sendWelcomeEmail(toEmail: string, name: string): Promise<boolean> {
  const mailOptions = {
    from: `"Ikonex Academy" <${env.gmailUser || 'noreply@ikonex.edu'}>`,
    to: toEmail,
 ...
 */
export async function sendLoginAlertEmail(toEmail: string, name: string): Promise<boolean> {
 ...
 */
export async function sendVerificationOTPEmail(toEmail: string, name: string, otpCode: string): Promise<boolean> {
  const mailOptions = {
    from: `"Ikonex Academy" <${env.gmailUser || 'noreply@ikonex.edu'}>`,
    to: toEmail,
 ...
 */
export async function sendTwoFactorLoginEmail(toEmail: string, name: string, code: string): Promise<boolean> {
  const mailOptions = {
    from: `"Ikonex Academy" <${env.gmailUser || 'noreply@ikonex.edu'}>`,
    to: toEmail,
...
export async function sendPasswordResetEmail(toEmail: string, name: string, code: string): Promise<boolean> {
  const mailOptions = {
    from: `"Ikonex Academy" <${env.gmailUser || 'noreply@ikonex.edu'}>`,
    to: toEmail,
